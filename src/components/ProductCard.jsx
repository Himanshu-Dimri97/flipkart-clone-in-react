                ...
                <div className="flex gap-2 pt-1 ">
                    {
                        product.discount ?
                            <>
                                <span className='text-sm sm:text-md text-black font-bold'>₹{parseInt(finalPrice)}</span>
                                <span className="text-sm sm:text-md line-through text-[#707070] font-semibold">₹{product.price}</span>
                            </>
                            :
                            <span className='text-sm sm:text-md text-black font-bold'>₹{parseInt(finalPrice)}</span>
                    }
